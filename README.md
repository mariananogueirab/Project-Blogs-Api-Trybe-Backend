...
Nesse projeto, foi construido um back-end usando `ORM` com o pacote `sequelize` do `npm`, que é capaz de:
...
1. Clone o repositório
  * `git clone git@github.com:mariananogueirab/Project-Blogs-Api-Trybe-Backend.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd Project-Blogs-Api-Trybe-Backend`
